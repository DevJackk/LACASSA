...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(lacassa..":NameBot:")
...
var =  'البابا جاك'
elseif  UserID == 839224120 then
var =  'مطور السورس'
elseif redis:sismember(lacassa..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(lacassa..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(lacassa..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(lacassa..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(lacassa..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(lacassa..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(lacassa..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(lacassa..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(lacassa..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(lacassa..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(lacassa..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(lacassa..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(lacassa..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(lacassa..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(lacassa..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(lacassa..':SUDO_BOT:')
message = '❍ ** قائمه الـمـطـوريـن : \n\n`❍ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(lacassa..'username:'..v)
local count = redis:scard(lacassa..'mtwr_count'..v)
...
local monsha = redis:smembers(lacassa..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n❍ قائمه المدراء :*\n\n'
local list = redis:smembers(lacassa..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(lacassa..'admins:'..msg.chat_id_)
...
local list = redis:smembers(lacassa..'whitelist:'..msg.chat_id_)
...
if redis:sismember(lacassa..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(lacassa..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(lacassa..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(lacassa..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(lacassa..'gban_users')
...
local list = redis:smembers(lacassa..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(lacassa..':Filter_Word:'..msg.chat_id_,word) then 
return  "❍ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(lacassa..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(lacassa..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(lacassa..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(lacassa..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(lacassa..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(lacassa..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(lacassa..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(lacassa..'group:ids')
message = '❍ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(lacassa..'group:name'..v)
if info then 
...
<style>*{font-family: 'Harmattan', sans-serif;font-weight: 600;text-shadow: 1px 1px 16px lacassa;}</style>
<body>
...
redis:del(
lacassa..'group:add'..id_group,
lacassa..'lock_link'..id_group, 
lacassa..'lock_id'..id_group,
lacassa..'lock_spam'..id_group, 
lacassa..'lock_webpage'..id_group,
lacassa..'lock_markdown'..id_group,
lacassa..'lock_flood'..id_group,
lacassa..'lock_bots'..id_group,
lacassa..'mute_forward'..id_group,
lacassa..'mute_contact'..id_group,
lacassa..'mute_location'..id_group,
lacassa..'mute_document'..id_group,
lacassa..'mute_keyboard'..id_group,
lacassa..'mute_game'..id_group,
lacassa..'mute_inline'..id_group,
lacassa..'lock_username'..id_group,
lacassa..'num_msg_lacassa'..id_group,
lacassa..'replay'..id_group
)
redis:srem(lacassa..'group:ids',id_group)
end
...
redis:hset(lacassa..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(lacassa..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(lacassa..'group:add'..msg.chat_id_) then  return '❍ **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(lacassa..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(lacassa..':addnumberusers') or 0)
...
local lock_service = redis:get(lacassa..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(lacassa..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(lacassa..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
lacassa..'group:add'..msg.chat_id_,true,
lacassa..'lock_link'..msg.chat_id_,true, 
lacassa..'lock_id'..msg.chat_id_,true,
lacassa..'lock_spam'..msg.chat_id_,true,
lacassa..'lock_webpage'..msg.chat_id_,true,
lacassa..'lock_markdown'..msg.chat_id_,true,
lacassa..'lock_flood'..msg.chat_id_,true,
lacassa..'lock_bots'..msg.chat_id_,true,
lacassa..'mute_forward'..msg.chat_id_,true,
lacassa..'mute_contact'..msg.chat_id_,true,
lacassa..'mute_location'..msg.chat_id_,true,
lacassa..'mute_document'..msg.chat_id_,true,
lacassa..'mute_keyboard'..msg.chat_id_,true,
lacassa..'mute_game'..msg.chat_id_,true,
lacassa..'mute_inline'..msg.chat_id_,true,
lacassa..'lock_username'..msg.chat_id_,true,
lacassa..'num_msg_lacassa'..msg.chat_id_,5, 
lacassa..'replay'..msg.chat_id_,true
)

redis:sadd(lacassa..'group:ids',msg.chat_id_) 
redis:sadd(lacassa..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(lacassa..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(lacassa..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(lacassa..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(lacassa..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(lacassa..'username:'..UserID,'username',Resolv)
redis:sadd(lacassa..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(lacassa..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(lacassa..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(lacassa..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(lacassa..'username:'..UserID,'username',Resolv)
redis:sadd(lacassa..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(lacassa..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(lacassa..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(lacassa..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(lacassa..'username:'..UserID, 'username', Resolv)
redis:sadd(lacassa..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(lacassa..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(lacassa..'whitelist:'..ChatID,UserID)
...
if redis:sismember(lacassa..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(lacassa..'username:'..UserID, 'username', Resolv)
redis:sadd(lacassa..'owners:'..ChatID,UserID)
...
if redis:sismember(lacassa..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(lacassa..'username:'..UserID, 'username', Resolv)
redis:sadd(lacassa..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(lacassa..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(lacassa..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(lacassa..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(lacassa..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(lacassa..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(lacassa..'username:'..UserID, 'username', Resolv)
redis:sadd(lacassa..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(lacassa..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(lacassa..'banned:'..ChatID,UserID)
...
if redis:sismember(lacassa..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(lacassa..'username:'..UserID, 'username', Resolv)
redis:sadd(lacassa..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(lacassa..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(lacassa..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(lacassa..'username:'..UserID, 'username',Resolv)
redis:sadd(lacassa..'gban_users',UserID)
...
redis:srem(lacassa..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء حظره العام \n',17,USERCAR) 
end
...
if redis:sismember(lacassa..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(lacassa..'username:'..UserID, 'username', Resolv)
redis:sadd(lacassa..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(lacassa..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(lacassa..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
redis:hset(lacassa..'username:'..UserID, 'username', UserName)
redis:sadd(lacassa..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(lacassa..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'❍ **العضو » ❪ '..UserName..' ❫\n❍ **الايدي » ❪ `'..UserID..'` ❫\n❍ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(lacassa..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(lacassa..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(lacassa..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(lacassa..'username:'..UserID, 'username', Resolv)
redis:sadd(lacassa..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(lacassa..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(lacassa..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'❍ **العضو » '..USERNAME..' \n❍ ** الايدي » (`'..UserID..'`)\n❍ **انه بالتأكيد ليس مطور \n') end
redis:srem(lacassa..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(lacassa..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(lacassa..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(lacassa..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(lacassa..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*❍*` اعدادات المجموعه :` \n"
.."\n❍ التعديل «» "..(redis:get(lacassa..'lock_edit'..msg.chat_id_) or 'false')
.."\n❍ الروابط «» "..(redis:get(lacassa..'lock_link'..msg.chat_id_) or 'false')
.."\n❍ التاك «» "..(redis:get(lacassa..'lock_tag'..msg.chat_id_) or 'false')
.."\n❍ المعرفات «» "..(redis:get(lacassa..'lock_username'..msg.chat_id_) or 'false')
.."\n❍ التكرار «» "..(redis:get(lacassa..'lock_flood'..msg.chat_id_) or 'false')
.."\n❍ الكلايش «» "..(redis:get(lacassa..'lock_spam'..msg.chat_id_) or 'false')
.."\n❍ الويب «» "..(redis:get(lacassa..'lock_webpage'..msg.chat_id_) or 'false')
.."\n❍ الماركدوان «» "..(redis:get(lacassa..'lock_markdown'..msg.chat_id_) or 'false')
.."\n❍ بالطرد البوتات «» "..(redis:get(lacassa..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n❍ البوتات «» "..(redis:get(lacassa..'lock_bots'..msg.chat_id_) or 'false')
.."\n❍ عدد التكرار «» "..(redis:get(lacassa..'num_msg_lacassa'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n❍`اعدادات الوسائط :`\n"
.."\n*❍ *المتحركه «» "..(redis:get(lacassa..'mute_gif'..msg.chat_id_) or 'false')
.."\n❍ الدردشه «» "..(redis:get(lacassa..'mute_text'..msg.chat_id_) or 'false')
.."\n❍ الانلاين «» "..(redis:get(lacassa..'mute_inline'..msg.chat_id_) or 'false')
.."\n❍ الالعاب «» "..(redis:get(lacassa..'mute_game'..msg.chat_id_) or 'false')
.."\n❍ الصور «» "..(redis:get(lacassa..'mute_photo'..msg.chat_id_) or 'false')
.."\n❍ الفيديو «» "..(redis:get(lacassa..'mute_video'..msg.chat_id_) or 'false')
.."\n❍ البصمات «» "..(redis:get(lacassa..'mute_audio'..msg.chat_id_) or 'false')
.."\n❍ الصوت «» "..(redis:get(lacassa..'mute_voice'..msg.chat_id_) or 'false')
.."\n❍ الملصقات «» "..(redis:get(lacassa..'mute_sticker'..msg.chat_id_) or 'false')
.."\n❍ الجهات «» "..(redis:get(lacassa..'mute_contact'..msg.chat_id_) or 'false')
.."\n❍ التوجيه «» "..(redis:get(lacassa..'mute_forward'..msg.chat_id_) or 'false')
.."\n❍ الموقع «» "..(redis:get(lacassa..'mute_location'..msg.chat_id_) or 'false')
.."\n❍ الملفات «» "..(redis:get(lacassa..'mute_document'..msg.chat_id_) or 'false')
.."\n❍ الاشعارات «» "..(redis:get(lacassa..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n❍ الكيبورد «» "..(redis:get(lacassa..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*❍*`اعدادات اخرى : `"
.."\n\n*❍*الترحيب «» "..welcomex
.."\n*❍*الردود «» "..replayx
...
.."\n*❍*الويب «» "..(redis:get(lacassa..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*❍*الماركدوان «» "..(redis:get(lacassa..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*❍*البوتات بالطرد «» "..(redis:get(lacassa..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*❍*البوتات «» "..(redis:get(lacassa..'lock_bots'..msg.chat_id_) or 'false')
.."\n*❍*عدد التكرار «» "..(redis:get(lacassa..'num_msg_lacassa'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*❍*اعدادات التقـييد :\n"
.."\n*❍*التقييد بالتوجيه «» "..(redis:get(lacassa..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالصور «» "..(redis:get(lacassa..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالروابط «» "..(redis:get(lacassa..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالمتحركه «» "..(redis:get(lacassa..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد الفيديو «» "..(redis:get(lacassa..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
